...
class Job(proto.Message):
    ...
    config = proto.Field(proto.MESSAGE, number=5, oneof='job_config',
        message='JobConfig',
    )

    priority = proto.Field(proto.INT32, number=6)

    origin_uri = proto.Field(proto.MESSAGE, number=7,
        message=OriginUri,
    )
    ...
    progress = proto.Field(proto.MESSAGE, number=9,
        message='Progress',
    )

    failure_reason = proto.Field(proto.STRING, number=10)

    failure_details = proto.RepeatedField(proto.MESSAGE, number=11,
    ...
    start_time = proto.Field(proto.MESSAGE, number=13,
        message=timestamp.Timestamp,
    )

    end_time = proto.Field(proto.MESSAGE, number=14,
        message=timestamp.Timestamp,
    )
...
class JobConfig(proto.Message):
    ...
    inputs = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Input',
    )

    edit_list = proto.RepeatedField(proto.MESSAGE, number=2,
        message='EditAtom',
    )

    elementary_streams = proto.RepeatedField(proto.MESSAGE, number=3,
        message='ElementaryStream',
    )

    mux_streams = proto.RepeatedField(proto.MESSAGE, number=4,
        message='MuxStream',
    )

    manifests = proto.RepeatedField(proto.MESSAGE, number=5,
        message='Manifest',
    )

    output = proto.Field(proto.MESSAGE, number=6,
        message='Output',
    )

    ad_breaks = proto.RepeatedField(proto.MESSAGE, number=7,
        message='AdBreak',
    )

    pubsub_destination = proto.Field(proto.MESSAGE, number=8,
        message='PubsubDestination',
    )

    sprite_sheets = proto.RepeatedField(proto.MESSAGE, number=9,
        message='SpriteSheet',
    )

    overlays = proto.RepeatedField(proto.MESSAGE, number=10,
        message='Overlay',
    )
...
class Input(proto.Message):
    ...
    preprocessing_config = proto.Field(proto.MESSAGE, number=3,
...
class EditAtom(proto.Message):
    ...
    end_time_offset = proto.Field(proto.MESSAGE, number=3,
        message=duration.Duration,
    )

    start_time_offset = proto.Field(proto.MESSAGE, number=4,
        message=duration.Duration,
    )
...
class ElementaryStream(proto.Message):
    ...
    video_stream = proto.Field(proto.MESSAGE, number=1, oneof='elementary_stream',
        message='VideoStream',
    )

    audio_stream = proto.Field(proto.MESSAGE, number=2, oneof='elementary_stream',
        message='AudioStream',
    )

    text_stream = proto.Field(proto.MESSAGE, number=3, oneof='elementary_stream',
        message='TextStream',
    )
...
class MuxStream(proto.Message):
    ...
    segment_settings = proto.Field(proto.MESSAGE, number=5,
        message='SegmentSettings',
    )

    encryption = proto.Field(proto.MESSAGE, number=6,
        message='Encryption',
    )
...
class SpriteSheet(proto.Message):
    ...
    start_time_offset = proto.Field(proto.MESSAGE, number=7,
        message=duration.Duration,
    )

    end_time_offset = proto.Field(proto.MESSAGE, number=8,
        message=duration.Duration,
    )

    total_count = proto.Field(proto.INT32, number=9, oneof='extraction_strategy')

    interval = proto.Field(proto.MESSAGE, number=10, oneof='extraction_strategy',
        message=duration.Duration,
    )
...
class Overlay(proto.Message):
    ...
    class Image(proto.Message):
        ...
        resolution = proto.Field(proto.MESSAGE, number=2,
    ...
    class AnimationStatic(proto.Message):
        ...
        xy = proto.Field(proto.MESSAGE, number=1,
            message='Overlay.NormalizedCoordinate',
        )

        start_time_offset = proto.Field(proto.MESSAGE, number=2,
            message=duration.Duration,
        )
    ...
    class AnimationFade(proto.Message):
        ...
        fade_type = proto.Field(proto.ENUM, number=1,
            enum='Overlay.FadeType',
        )

        xy = proto.Field(proto.MESSAGE, number=2,
            message='Overlay.NormalizedCoordinate',
        )

        start_time_offset = proto.Field(proto.MESSAGE, number=3,
            message=duration.Duration,
        )

        end_time_offset = proto.Field(proto.MESSAGE, number=4,
            message=duration.Duration,
        )
    ...
    class Animation(proto.Message):
        ...
        animation_static = proto.Field(proto.MESSAGE, number=1, oneof='animation_type',
            message='Overlay.AnimationStatic',
        )

        animation_fade = proto.Field(proto.MESSAGE, number=2, oneof='animation_type',
            message='Overlay.AnimationFade',
        )

        animation_end = proto.Field(proto.MESSAGE, number=3, oneof='animation_type',
    ...
    animations = proto.RepeatedField(proto.MESSAGE, number=2,
        message=Animation,
    )
...
class PreprocessingConfig(proto.Message):
    ...
    denoise = proto.Field(proto.MESSAGE, number=2,
        message=Denoise,
    )

    deblock = proto.Field(proto.MESSAGE, number=3,
        message=Deblock,
    )

    audio = proto.Field(proto.MESSAGE, number=4,
        message=Audio,
    )
...
class VideoStream(proto.Message):
    ...
    gop_duration = proto.Field(proto.MESSAGE, number=16, oneof='gop_mode',
        message=duration.Duration,
    )
...
class AudioStream(proto.Message):
    ...
    class AudioAtom(proto.Message):
        ...
        class AudioChannel(proto.Message):
            ...
            inputs = proto.RepeatedField(proto.MESSAGE, number=2,
                message='AudioStream.AudioAtom.AudioChannel.AudioChannelInput',
            )

        key = proto.Field(proto.STRING, number=1)

        channels = proto.RepeatedField(proto.MESSAGE, number=2,
    ...
    mapping = proto.RepeatedField(proto.MESSAGE, number=5,
        message=AudioAtom,
    )
...
class TextStream(proto.Message):
    ...
    mapping = proto.RepeatedField(proto.MESSAGE, number=3,
        message=TextAtom,
    )
...
class SegmentSettings(proto.Message):
    ...
    segment_duration = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )
...
class Encryption(proto.Message):
    ...
    aes_128 = proto.Field(proto.MESSAGE, number=3, oneof='encryption_mode',
        message=Aes128Encryption,
    )

    sample_aes = proto.Field(proto.MESSAGE, number=4, oneof='encryption_mode',
        message=SampleAesEncryption,
    )

    mpeg_cenc = proto.Field(proto.MESSAGE, number=5, oneof='encryption_mode',
