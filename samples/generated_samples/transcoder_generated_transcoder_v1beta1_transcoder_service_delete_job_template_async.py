...
# [START transcoder_generated_transcoder_v1beta1_TranscoderService_DeleteJobTemplate_async]
from google.cloud.video import transcoder_v1beta1


async def sample_delete_job_template():
    # Create a client
    client = transcoder_v1beta1.TranscoderServiceAsyncClient()
...
# [END transcoder_generated_transcoder_v1beta1_TranscoderService_DeleteJobTemplate_async]
